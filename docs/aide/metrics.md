...
| Date | Batch | prs_merged | needs_human | ci_red_hours | skills_count | todo_shipped | time_to_merge_avg_min | vision_prs | session_outcome | arch_convergence | sim_floor_delta | queue_guard_fires | meaningful_prs | Notes |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
