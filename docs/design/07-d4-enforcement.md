...
## Future (🔲)
- ✅ ⚠️ Inferred: D4 classification at issue intake — coord.md §1e now executable: reads issue title, classifies as DECLARATIVE/INFRA/IMPERATIVE, posts [📋 D4 TRANSLATION] for IMPERATIVE titles. Fail-open on gh API errors. No 60s sleep (standalone.md §D4 "Proceed immediately"). (PR #581, 2026-04-20)
