...
- ✅ SM §4f health signal includes managed project velocity gate: counts feat/fix/refactor PRs merged on the reference project in the last 14 days; if 0 and self is GREEN → AMBER. Health comment includes "Managed: N feat PRs/14d (reference: <repo>)". Fail-open on API errors. (PR #783, 2026-04-21)
