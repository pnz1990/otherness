...
## Future (🔲)
- ✅ 37.12 — Pressure context maximum age contract: `otherness-config.yaml` accepts `vision.pressure_max_age_days` (default: 14). SCAN 5 §42.4 reads this field; exceeding it is a mandatory rewrite trigger independent of addressed ratio. (PR #858, 2026-04-23)
