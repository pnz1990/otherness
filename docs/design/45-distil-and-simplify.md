...
- ✅ 45.5 — Simplification cycle scheduled: added to SM §4a triage — every 30 batches, SM opens a `kind/chore priority/high` issue: "Simplification cycle: distil sm.md, coord.md, eng.md, qa.md." Dedup guard prevents duplicates. (PR #TBD, 2026-04-23)
