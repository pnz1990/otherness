...
- ✅ 45.1 — Audit and reduce sm.md: removed §4d/4e (simulation calibration, 1006 lines), compressed §4c/4c-skill/4g-anchor*/PROGRESS/QA_REJECT/README_SHIPPED/SCHEMA blocks. sm.md: 5,070 → 1,895 lines. (PR #971, 2026-04-23)
...
- ✅ 45.5 — Simplification cycle scheduled: added to SM §4a triage — every 30 batches, SM opens a `kind/chore priority/high` issue: "Simplification cycle: distil sm.md, coord.md, eng.md, qa.md." Dedup guard prevents duplicates. (PR #971, 2026-04-23)
