...
- ✅ 43.2 — COORD §1d: when creating a GitHub issue, immediately add it to the project board with `Status: Todo` and set the `active_milestone`. Two API calls after `gh issue create`. (PR #956-impl, 2026-04-23)
...
- ✅ 43.4 — ENG §2f: when opening the PR, set board `Status: In Review`. One GraphQL mutation. Non-blocking: failure silently skipped. (PR #issue-951, 2026-04-23)
