...
- ✅ PM competitive comparison produces `docs/aide/competitive-standing.md` — four-dimension scored rubric (reliability, self-improvement, onboarding, visibility); PM §5c appends one row per 10-batch cycle; SM §4b includes competitive delta in health comment (feat/issue-889, 2026-04-22)
