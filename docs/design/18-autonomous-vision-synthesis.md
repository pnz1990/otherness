...
- 🔲 ⚠️ Inferred: definition-of-done Journey 9 — autonomous vision synthesis: when queue empties, SM §4h should run, produce ≥1 ⚠️ Inferred item, and COORD should pick it up without human restart. (autonomous-vision, 2026-04-20)
